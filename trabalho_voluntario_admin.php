      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="#" method="#">
            ...
            <input type="text" class="form-control mt-3" placeholder="Título" />
            <input type="url" class="form-control mt-3" placeholder="Imagem" />
            <textarea class="form-control mt-3" cols="30" rows="5" placeholder="Descrição"></textarea>
            <input type="number" class="form-control mt-3" placeholder="Número de vagas" />

          </form>
        </div>
        <div class="modal-footer">
            <button type="button" class="btn btn-info">Salvar mudanças</button>
