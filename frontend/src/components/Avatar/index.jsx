...
const Avatar = ({ data }) => {
    return (
        <Container>
            ...
            <Row>
                <Col className="p-3">
                    <a href={data.github} target="_blank"><Image src={github} roundedCircle width="50" className="float-right" /></a>
                </Col>
                <Col className="p-3">
                    <a href={data.linkedIn} target="_blank"><Image src={linkedIn} roundedCircle width="50" className="float-left" /></a>
                </Col>
            </Row>
        </Container>
    )
